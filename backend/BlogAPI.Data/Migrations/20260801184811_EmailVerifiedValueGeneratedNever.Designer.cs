...
namespace BlogAPI.Data.Migrations
{
    ...
    [Migration("20260801184811_EmailVerifiedValueGeneratedNever")]
    partial class EmailVerifiedValueGeneratedNever
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogAPI.Domain.Entities.Follow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BlogAPI.Domain.Entities.Like", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BlogAPI.Domain.Entities.MediaFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BlogAPI.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasAnnotation("Npgsql:TsVectorProperties", new[] { "Title", "Excerpt", "Content" });
            ...
            modelBuilder.Entity("BlogAPI.Domain.Entities.Follow", b =>
                {
                    b.HasOne("BlogAPI.Domain.Entities.User", "FollowerUser")
                        .WithMany()
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlogAPI.Domain.Entities.User", "FollowingUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BlogAPI.Domain.Entities.MediaFile", b =>
                {
                    b.HasOne("BlogAPI.Domain.Entities.User", "UploadedBy")
                        .WithMany()
